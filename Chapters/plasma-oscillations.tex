...
\begin{equation}
    R:=S+D=1-\sum_\sigma\frac{\omega_{\mathrm{p}\sigma}^2}{\omega(\omega+\Omega_\sigma)}\qquad L:=S-D=1-\sum_\sigma\frac{\omega_{\mathrm{p}\sigma}^2}{\omega(\omega-\Omega_\sigma)}
\end{equation}
